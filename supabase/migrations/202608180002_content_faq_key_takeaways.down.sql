-- Reverts 202608180002_content_faq_key_takeaways.sql: restores
-- public_content_items and save_content_draft to their pre-migration
-- bodies (from 202608160001/202608160002), then drops the two columns.
...
alter table public.content_items
  drop constraint if exists content_items_key_takeaways_is_array,
  drop constraint if exists content_items_faqs_is_array;
