...
function SquareButton({
  ...
  return (
    <button
      className="relative flex h-16 w-full items-center justify-center bg-navy-900 px-8 font-sans text-button text-white transition-colors hover:bg-navy-700 disabled:pointer-events-none disabled:opacity-70"
      {...rest}
    >
      {children}
