...
export function HeroSolidPanel({
  ...
  return (
    <section className="relative flex flex-col overflow-hidden lg:-mt-[176px] lg:min-h-[860px] lg:flex-row">
      <div className="relative min-h-[620px] min-w-0 lg:min-h-full lg:flex-1">
        <Image
          src={background.src}
          alt={background.alt}
          fill
        ...
        <Container>
          <div className="container relative z-10 flex h-full flex-col justify-start pt-[120px] pb-24 lg:pb-16 lg:pt-[170px] lg:pr-12">
            ...
            <p className="max-w-[560px] font-sans text-body-lg text-white mt-4">
            ...
            {callPill && (
              ...
              >
                ...
                <span className="flex flex-col">
                  ...
                  <span className="font-display text-h2 text-white leading-10 underline decoration-transparent underline-offset-4 transition-colors duration-300 group-hover:decoration-current">
                    {callPill.phone}
                  </span>
                </span>
              </a>
      ...
      <div className="relative hidden flex-col justify-start bg-navy-900 px-6 pb-16 sm:px-10 lg:flex lg:w-[640px] lg:shrink-0 lg:px-16 lg:pb-0 lg:pt-[170px] xl:w-[760px] 2xl:w-[800px]">
        {formSlot ??
          (form && (
            <LeadForm
              heading={form.heading}
