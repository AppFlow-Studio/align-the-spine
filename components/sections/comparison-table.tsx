          ...
          <Card radius={30} shadow="comparison" className="overflow-hidden">
            <div className="snap-x snap-mandatory overflow-x-auto">
              <div className="grid min-w-[720px] grid-cols-3">
                <div className="snap-start bg-navy-900 px-6 py-8 md:px-8">
                ...
                <div className="snap-start bg-panel-100 px-6 py-8 md:px-8">
...
function ComparisonRowCells({ row }: { row: ComparisonRow }) {
  return (
    <>
      <div className="snap-start border-t border-overlay-white-15 bg-navy-900 px-6 py-6 md:px-8">
      ...
      <div className="snap-start flex items-start gap-3 border-t border-mute-300 bg-panel-100 px-6 py-6 md:px-8">
