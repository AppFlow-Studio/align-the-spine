...
export function Footer() {
  ...
  return (
    <footer className="border-t border-white/10 bg-navy-900">
      <div className="container flex flex-col gap-16 py-10 lg:flex-row lg:justify-between">
        <div className="w-[40vw] flex flex-col gap-6 lg:max-w-xs xl:max-w-lg">
          <Image
        ...
        <div className="w-[60vw] flex flex-col gap-12 sm:flex-row sm:gap-24">
