...
export function fieldControlClasses(variant: FieldVariant, hasError: boolean) {
  return cn(
    "w-full rounded-6 border-[0.5px] px-4 font-sans text-field outline-none transition-colors",
    variant === "dark"
      ? "border-white bg-overlay-white-16 text-white placeholder:text-white focus:outline-2 focus:-outline-offset-1 focus:outline-white/70"
