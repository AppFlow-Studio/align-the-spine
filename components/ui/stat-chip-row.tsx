...
/** Inline stat-chip row sharing TopStatsBar's data (content/site.ts's
 * getVerifiedStats()) with a glass-pill treatment for dark hero
 * backgrounds, per condition-page-spec §B2. */
