...
import { htBackPain } from "@/content/ht/conditions";
...
const route = getHtRoute("/ht/kondisyon-nou-trete/doule-do");

export const metadata: Metadata = buildHtRouteMetadata(route);

/** /ht/kondisyon-nou-trete/doule-do — Haitian Creole counterpart of
 ...
 * nav.
 */
export default function HtBackPainPage() {
  return (
    <>
      <JsonLd
        data={buildWebPage({
      ...
      />
      <HtConditionPage condition={htBackPain} />
    </>
  );
}
