...
import { htConcussion } from "@/content/ht/conditions";
...
const route = getHtRoute("/ht/kondisyon-nou-trete/konmosyon-serebral");

export const metadata: Metadata = buildHtRouteMetadata(route);

/** /ht/kondisyon-nou-trete/konmosyon-serebral — Haitian Creole counterpart
 * of /conditions/concussion and /es/condiciones/conmocion-cerebral.
 *
 ...
 * nav.
 */
export default function HtConcussionPage() {
  return (
    <>
      <JsonLd
        data={buildWebPage({
      ...
      />
      <HtConditionPage condition={htConcussion} />
    </>
  );
}
