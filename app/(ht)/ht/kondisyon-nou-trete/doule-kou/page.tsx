...
import { htNeckPain } from "@/content/ht/conditions";
...
const route = getHtRoute("/ht/kondisyon-nou-trete/doule-kou");

export const metadata: Metadata = buildHtRouteMetadata(route);

/** /ht/kondisyon-nou-trete/doule-kou — Haitian Creole counterpart of
 * /conditions/neck-pain and /es/condiciones/dolor-de-cuello.
 *
 ...
 * nav.
 */
export default function HtNeckPainPage() {
  return (
    <>
      <JsonLd
        data={buildWebPage({
      ...
      />
      <HtConditionPage condition={htNeckPain} />
    </>
  );
}
