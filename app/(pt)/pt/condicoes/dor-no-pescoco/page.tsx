...
import { ptNeckPain } from "@/content/pt/conditions";
import { getPtRoute } from "@/content/pt/seo";
import { buildWebPage } from "@/lib/schema";
import { buildPtRouteMetadata } from "@/lib/seo/metadata";

const route = getPtRoute("/pt/condicoes/dor-no-pescoco");

export const metadata: Metadata = buildPtRouteMetadata(route);

/** /pt/condicoes/dor-no-pescoco — Brazilian Portuguese counterpart of
 ...
 */
export default function PtNeckPainPage() {
  return (
    <>
      <JsonLd
        data={buildWebPage({
      ...
      />
      <PtConditionPage condition={ptNeckPain} />
    </>
  );
}
